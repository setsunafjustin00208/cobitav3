...
/**
 * Class CreateViewPage
 *
 * This command allows you to create new view files in the app/view/pages directory.
 *
 * Usage:
 *  php spark createView:Page
 *
 * Description:
 * - createView:Page: Creates a new view file in the app/view/pages directory.
 *
 * Command Prompts:
 * 1. Folder Name: You can specify a custom folder name. If you leave this prompt empty, the default folder (pages) will be used.
 ...
 *  php spark createView:Page
 *  - Prompt: Enter the folder name (leave empty to use "pages")
 *    - Input: customPages (or leave empty to use pages)
 *  - Prompt: Enter the file name (without extension)
 *    - Input: home
 *  This will create a file named home.php in the app/view/customPages directory (or app/view/pages if the folder name was left empty).
 */
class CreateViewPage extends BaseCommand
{
    /**
     * The Command's Group
     *
     ...
     * @var string
     */
    protected $name = 'createView:Page';
     ...
     * @var string
     */
    protected $description = 'Creates a new view file in the app/view/pages directory';
     ...
     * @var string
     */
    protected $usage = 'createView:Page';
